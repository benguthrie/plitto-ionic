  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.lists.findById() instead.
        "prototype$__findById__lists": {
          url: urlBase + "/users/:id/lists/:fk",
          method: "GET",
        },

        // INTERNAL. Use User.lists.destroyById() instead.
        "prototype$__destroyById__lists": {
          url: urlBase + "/users/:id/lists/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use User.lists.updateById() instead.
        ...
        // INTERNAL. Use User.lists() instead.
        "prototype$__get__lists": {
          url: urlBase + "/users/:id/lists",
          method: "GET",
          isArray: true,
        },

        // INTERNAL. Use User.lists.create() instead.
        "prototype$__create__lists": {
          url: urlBase + "/users/:id/lists",
          method: "POST",
        },

        // INTERNAL. Use User.lists.destroyAll() instead.
        "prototype$__delete__lists": {
          url: urlBase + "/users/:id/lists",
          method: "DELETE",
        },

        // INTERNAL. Use User.lists.count() instead.
        "prototype$__count__lists": {
          url: urlBase + "/users/:id/lists/count",
          method: "GET",
        },
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.lists
     * @object
     * @description
     *
     * The object `User.lists` groups methods
     * manipulating `List` instances related to `User`.
     *
     * Use {@link lbServices.User#lists} to query
     ...
     */
        ...
        R.lists = function() {
          ...
          var action = TargetResource["::get::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#count
         * @methodOf lbServices.User.lists
         *
         * @description
         *
         * Counts lists of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.lists.count = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::count::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#create
         * @methodOf lbServices.User.lists
         *
         * @description
         *
        ...
        R.lists.create = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::create::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#destroyAll
         * @methodOf lbServices.User.lists
         *
         * @description
         *
        ...
        R.lists.destroyAll = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::delete::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#destroyById
         * @methodOf lbServices.User.lists
         *
         * @description
         *
        ...
        R.lists.destroyById = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::destroyById::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#findById
         * @methodOf lbServices.User.lists
         *
         * @description
         *
        ...
        R.lists.findById = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::findById::user::lists"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.lists#updateById
         * @methodOf lbServices.User.lists
         *
         * @description
         *
        ...
        R.lists.updateById = function() {
          var TargetResource = $injector.get("List");
          var action = TargetResource["::updateById::user::lists"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.lists.destroyById() instead.
        "::destroyById::user::lists": {
          url: urlBase + "/users/:id/lists/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use User.lists.updateById() instead.
        "::updateById::user::lists": {
          url: urlBase + "/users/:id/lists/:fk",
          method: "PUT",
        },
