...
.factory('dbFactory', ['$http', '$rootScope', '$state', 'localStorageService', function ($http, $rootScope, $state, localStorageService) {
    ...
    var promise = $http.post(apiPath + 'listOfLists', params)
      .then(function (response) {
          if (checkLogout(response.data) === true) {
            ...
            localStorageService.set('user' + friendId + 'lists', response.data.results);
  ...
  */
  ...
  return {
    ...
    // 1/27/2015 plittoFBApiCall: plittoFBApiCall,
    ...
    // 1/27/2015 sharedStat: sharedStat,
    /* 9/7/2014 */
    // , modalReset: modalReset
    // 1/27/2015 showAList: showAList,
    // 1/27/2015 getMore: getMore,
    // 1/27/2015 getMoreAppend: getMoreAppend,
    // 1/27/2015 newList: newList,
    // 1/27/2015 addToList: addToList,

    /* Removed 1/23/2015 search: search, */
    /* Removed 1/23/2015 showThing: showThing, */
    // 1/27/2015 showUser: showUser,
    // 1/27/2015 showFeed: showFeed,
    // 1/27/2015 loadList: loadList,
    fbTokenLogin: fbTokenLogin,
    refreshData: refreshData,
    dbInit: dbInit,
    /* Initializes the rootscope */
    /* Removed 1/23/2015 mainFeed: mainFeed, // Updates the main feed */
    /* Removed 1/27/2015 loadFeed: loadFeed, Moved into the controllers. */
    ...
    /* Removed 1/27. Had never been implemented. cleanOtherScope: cleanOtherScope, */
...
/* TODO2 - Re-integrate this later 1/27/2015
...
*/
  ...
  /* 11/12/2014 - Created - 1/27/2015 - Retired 
 ...
 */
  ...
  */
  ...
  /* 9/3/2014 / 9.5.2014
    ...
    1/27/2015 - This is about to get used. 
        ...
        function (data, status, headers, config) {
          ...
          if (checkLogout(data) === true) {
            ...
            if (type === 'list') {
              ...
              // NO - Not if I can help it. $rootScope.list.items = data.results;
  ...
  */
  ...
  /* TODO1 - Is this what's being used now? Let's disable to find out. 1/27/2015
